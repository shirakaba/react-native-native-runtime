//
// Forked from https://github.com/mrousavy/react-native-vision-camera/blob/7206a794a9e1a2da4def7fdf4d8a70c9eb7f43ff/android/src/main/cpp/JSIJNIConversion.cpp
//
...
jsi::Value JSIJNIConversion::convertJNIObjectToJSIValue(jsi::Runtime &runtime, const jni::local_ref<jobject>& object) {
  ...
  __android_log_write(ANDROID_LOG_ERROR, "JavaRuntime", message.c_str());
  throw std::runtime_error(message);
}
